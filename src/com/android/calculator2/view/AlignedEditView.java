 ...
 */
public class AlignedEditView extends EditText {
    ...
    public AlignedEditView(Context context) {
        this(context, null /* attrs */);
    }

    public AlignedEditView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public AlignedEditView(Context context, AttributeSet attrs, int defStyleAttr) {
