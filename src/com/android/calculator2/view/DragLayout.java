...
public class DragLayout extends ViewGroup {
    ...
    public static final int EXTRA_RESULT_HEIGHT = 100;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mHistoryFrame.getVisibility() != VISIBLE && mDragHelper.getViewDragState() == ViewDragHelper.STATE_IDLE) {
            mVerticalRange = mVerticalRange - EXTRA_RESULT_HEIGHT;
        }
    ...
    public void setClosed(boolean isAnim) {
        if (!isAnim) {
            setOpen(false);
