...
package com.android.calculator2.adapter;
...
import com.android.calculator2.view.AlignedTextView;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v, int viewType) {
            ...
            mFormula.setTextIsSelectable(true);
            ...
            mSelectionActionModeCallback = new ActionMode.Callback2() {
                ...
                public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                    ...
                    final MenuItem selectItem = menu.findItem(android.R.id.selectAll);
            ...
            mFormula.setCustomSelectionActionModeCallback(mSelectionActionModeCallback);
        }
